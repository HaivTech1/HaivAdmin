import { CogIcon, EyeIcon, PlayIcon, SaveAsIcon, SaveIcon } from '@heroicons/react/solid'
...
const PostForm = ({ initialPost, busy, postBtnTitle, resetAfterSubmit, onSubmit }) => {
  const { user } = useAdmin()
  ...
  const { title, subtitle, content, tags, meta, featured, thumbnail } = postInfo
  ...
  const handleChange = ({ target }) => {
    ...
    if (name === 'featured') {
      localStorage.setItem('postStore', JSON.stringify({ ...postInfo, featured: checked }))
      ...
      <form onSubmit={handleSubmit}>
        <div className="">
          <div className=" p-4 rounded-lg">
            ...
            <div className="">
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 m-4">
                <div className="">
                ...
                <div className="">
                  <Label htmlFor="grid-password">Meta {meta?.length} / 150</Label>
